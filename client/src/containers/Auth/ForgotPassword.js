  ...
  sendEmail = async (e) => {
    ...
    if (email === "") {
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_PROXY}/forgotPassword`,
        { email }
      );
            ...
            <div className="mb-4">
              ...
              <input
                className={classnames(
                  ...
                  {
                    showNullError: "border-red-500 mb-3",
                    showError: "border-red-500 mb-3",
                    messageFromServer: "border-tekno3 mb-3",
                  }
                )}
                id="email"
                label="email"
              ...
              {showError && (
                <div className="text-red-500 text-xs italic">
                  Bu E-posta adresi kayıtlı değildir. Lütfen tekrar deneyin veya
                  üye olun.
                </div>
              )}
              {messageFromServer && (
                <div className="text-tekno3 text-sm font-medium">
                  Şifre sıfırlama E-postası başarıyla gönderilmiştir!
                </div>
              )}
            </div>
