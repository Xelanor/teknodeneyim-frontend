...
class DisplayOffers extends Component {
  ...
  getData() {
    axios
      .get(`${process.env.REACT_APP_PROXY}/admin/posts/show-passive`)
  ...
  acceptPost = (postId) => {
    axios
      .post(`${process.env.REACT_APP_PROXY}/admin/posts/accept`, { postId })
  ...
  declinePost = (postId) => {
    axios
      .post(`${process.env.REACT_APP_PROXY}/admin/posts/decline`, { postId })
      .then((res) => console.log(res))
      .catch((err) => {
        console.log(err);
      });
