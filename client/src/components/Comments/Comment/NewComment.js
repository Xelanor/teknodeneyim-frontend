  ...
  return (
      <div className="mt-16 items-center">
        <form onSubmit={props.submitForm}>
          <input type="text" name="name" value={props.comment} onChange={props.onCommentChange} placeholder="Yorum Yap..." className="outline-none bg-purple-white shadow rounded-lg border-0 p-8 pr-32 focus:border-tekno mb-2"/><br />
