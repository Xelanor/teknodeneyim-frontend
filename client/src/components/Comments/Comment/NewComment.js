  ...
  return (
    <div className="mt-16 w-full md:w-1/2 mx-auto text-center items-center">
      <form onSubmit={props.submitForm}>
        <textarea disabled={props.loading} type="text" name="name" value={props.comment} onChange={props.onCommentChange} placeholder="Yorum Yap..." rows="3" className="form-textarea outline-none bg-purple-white shadow rounded-lg border-0 p-2 w-full block focus:border-tekno mb-2 mr-2 appearance-none" />
