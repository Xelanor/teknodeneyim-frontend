const TimeAgo = Time => {
  ...
  let time_formats = [
    [60, 'sn', 1], // 60
    [120, '1dk önce', '1dk sonra'], // 60*2
    [3600, 'dk', 60], // 60*60, 60
    [7200, '1s önce', '1s sonra'], // 60*60*2
    [86400, 's', 3600], // 60*60*24, 60*60
    [172800, '1g önce', '1g sonra'], // 60*60*24*2
    [604800, 'g', 86400], // 60*60*24*7, 60*60*24
    [1209600, '1h önce', '1h sonra'], // 60*60*24*7*4*2
    [2419200, 'h', 604800], // 60*60*24*7*4, 60*60*24*7
    [4838400, '1a önce', '1a sonra'], // 60*60*24*7*4*2
    [29030400, 'a', 2419200], // 60*60*24*7*4*12, 60*60*24*7*4
    [58060800, '1y önce', '1y sonra'], // 60*60*24*7*4*12*2
